...
class RilievoMisure(SQLModel, table=True):
    ...
    piani_gru_0_1: Optional[str] = Field(default=None)
    piani_2_3: Optional[str] = Field(default=None)
    piani_4_5: Optional[str] = Field(default=None)
    piani_6_7: Optional[str] = Field(default=None)
