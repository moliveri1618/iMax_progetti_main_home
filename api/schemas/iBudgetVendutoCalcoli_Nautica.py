...
class BudgetVendutoCalcoliNauticaBase(BaseModel):
...
class BudgetVendutoCalcoliNauticaCreate(BudgetVendutoCalcoliNauticaBase):
    pass


class BudgetVendutoCalcoliNauticaRead(BudgetVendutoCalcoliNauticaBase):
    id: int


class BudgetVendutoCalcoliNauticaUpdate(BaseModel):
    user_id: Optional[str] = None
    mese: Optional[str] = None
...
class BudgetVendutoCalcoliNauticaBulkUpdateItem(BaseModel):
...
class BudgetVendutoCalcoliNauticaBulkUpdate(BaseModel):
    table: List[BudgetVendutoCalcoliNauticaBulkUpdateItem]