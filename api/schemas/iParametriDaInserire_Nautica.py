...
class ParametriDaInserireNauticaBase(BaseModel):
    mese: str
...
class ParametriDaInserireNauticaCreate(ParametriDaInserireNauticaBase):
    pass


class ParametriDaInserireNauticaRead(SQLModel):
    id: int
    user_id: str
    mese: str
    obiettivo_mensile: float
...
class ParametriDaInserireNauticaUpsert(SQLModel):
...
class ParametriDaInserireNauticaUpdate(BaseModel):
...
class ParametriNauticaBulkUpdateItem(BaseModel):
    id: Optional[int]           
    mese: str
    obiettivo_mensile: float
    perc_premio_trimestrale: Optional[float] = None
...
class ParametriNauticaRowIn(SQLModel):
    mese: str
    obiettivo_mensile: float
    perc_premio_trimestrale: Optional[float] = None
    perc_premio_annuale: Optional[float] = None
...
class ParametriNauticaBulkUpdate(BaseModel):
    table: List[ParametriNauticaBulkUpdateItem]
