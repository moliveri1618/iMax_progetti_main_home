...
class IWorkInProgressNauticaBase(BaseModel):
    commesse_id: int
    zona: str
    modello: str
    colonna: str
...
class IWorkInProgressNauticaRead(SQLModel):
    id: int
    commesse_id: int
    zona: str
    modello: str
...
class IWorkInProgressNauticaUpdate(BaseModel):
...
class IWorkInProgressWithCollaudo(IWorkInProgressNauticaRead):
    collaudo_finale: Optional[ICollaudoFinaleNauticaRead] = None


class WorkInProgressNauticaGroupedV2(BaseModel):
    zona: str
    modello: str
